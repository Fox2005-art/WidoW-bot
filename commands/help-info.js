...
module.exports = {
    run: (message, args, client) => {
        ...
        .setDescription(`_${setting} Voici toutes les commandes d'information._`)
        .addField(`Commandes d'information`, [
            `${arrow} \`w=serverinfo\`, \`w=roleinfo\`, \`w=userinfo\`, \`w=mcserver\`, \`w=appinfo\`\n\nUne question? rejoint le __[Server-Support](https://discord.gg/yXN8xUaxjn)__`,
        ]))
    },
    name: 'help-info'
}